    ...
    <>
      ...
      <div className="max-w-[72rem] mx-auto px-3">
        ...
        <h2 className="mb-[2rem]">
          ...
          using an Online/Source account. No other refunds for purchased Credits
          are available.
          <br />
        ...
        <p className="mb-[2rem]">
          Astrological consultations are subjective, and different astrologers
          may provide varying results. Credits spent are intended to compensate
          Astrologer Partners for their time and effort, and not for any
          specific output. No refunds will be issued for any inaccuracies,
