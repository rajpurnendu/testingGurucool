  ...
  return (
    <>
         <div className="flex flex-col items-center gap-[0.5rem]">
            ...
            <h3
              className="text-[0.875rem] leading-normal font-medium text-gray-900"
              id="modal-title"
            >
              Dr. Balkrishna Ji
            </h3>
            <div className="flex justify-center items-center gap-[0.1rem]">
              <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem]" />
              <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem]" />
              <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem]" />
              <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem]" />
              <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem]" />
            ...
            <div className="flex justify-center items-center">
              ...
              <span className="text-[0.75rem] font-normal text-slate-700 ml-[0.32rem]">
                Hindi, English, Tamil
              </span>
            </div>
          </div>
          <div className="flex flex-wrap justify-center items-center gap-[0.75rem] ">
            <div className="py-[0.25rem] px-[0.5rem] bg-[#D9D9D9] text-slate-600 rounded-[1.33rem] ">
              Palmestry
            </div>
            <div className="py-[0.25rem] px-[0.5rem] bg-[#D9D9D9] text-slate-600 rounded-[1.33rem] ">
              Palmestry
          ...
          <div className="w-[11.875rem] py-[0.66rem] border-t-[0.196px] border-b-[0.196px] border-gray-700 ">
            <div className="w-full flex">
              <div className="flex flex-col items-center gap-[0.5rem] p-[0.17rem]">
                <h3 className="text-[0.75rem] font-normal">
                  Consultation Charges
                </h3>
                <h4 className="text-[0.875rem] font-semibold text-violet-600 ">
                  ₹5/min
                </h4>
              </div>
              <div className="w-[0.196px] bg-gray-700 mx-[0.66rem]"></div>
              <div className="flex flex-col items-center gap-[0.5rem] p-[0.17rem]">
                <h3 className="text-[0.75rem] font-normal">
                  Your Wallet Balance
                </h3>
          ...
          <div className="flex">
            <div>
              <h6 className="text-[0.75rem] font-medium leading-normal ">
                Note:{" "}
              </h6>
            </div>
            <div className="w-[11rem] ml-[0.27rem] ">
              <h5 className="text-left text-[0.75rem] font-normal">
                Based on the amount in your wallet you will be disconnected
                after{" "}
                <span className="text-red-500 text-[0.75rem] font-normal">
                  X mins
                </span>
              </h5>
            </div>
