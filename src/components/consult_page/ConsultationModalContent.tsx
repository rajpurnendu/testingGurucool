  ...
  return (
    <>
      <div className="flex flex-col items-center gap-[0.5rem]">
        ...
        <div className="w-[3.2rem] h-[3.2rem] md:w-[6.52rem] md:h-[6.52rem] rounded-full">
          <Image
        ...
        <h3
          className="text-[0.875rem] md:text-[1.125rem] leading-normal font-medium text-gray-900"
          id="modal-title"
        >
          {astroDetails?.user?.firstName} {astroDetails?.user?.lastName}
        </h3>
        <div className="flex justify-center items-center gap-[0.1rem] md:gap-[0.22rem]">
          <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem] md:w-[1.47rem] md:h-[1.47rem]" />
          <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem] md:w-[1.47rem] md:h-[1.47rem]" />
          <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem] md:w-[1.47rem] md:h-[1.47rem]" />
          <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem] md:w-[1.47rem] md:h-[1.47rem]" />
          <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem] md:w-[1.47rem] md:h-[1.47rem]" />
        ...
        <div className="flex justify-center items-center">
          <svg
            ...
            viewBox="0 0 12 13"
            fill="none"
            className="w-3 h-3 lg:w-[1.52rem] lg:h-[1.6rem]"
          >
            <path
      ...
      <div className="flex flex-wrap justify-center items-center gap-[0.75rem] md:gap-4 ">
        {astroDetails?.skills.slice(0, 4).map((curr: any, index: number) => {
          return (
            <div
              key={index}
              className="py-[0.25rem] md:py-[0.75rem] px-[0.5rem] md:px-6 bg-[#D9D9D9] md:text-xs text-slate-600 rounded-[1.33rem] md:rounded-[4rem] "
            >
              {curr}
            </div>
          );
      ...
      <div className="w-[11.875rem] md:w-full py-[0.66rem] md:py-[1.39rem] border-t-[0.196px] border-b-[0.196px] border-gray-700 ">
        <div className="w-full flex md:justify-center">
          <div className="flex flex-col items-center gap-[0.5rem] md:gap-4 p-[0.17rem]">
            <h3 className="text-[0.75rem] md:text-sm font-normal">
              Consultation Charges
            </h3>
            <h4 className="text-[0.875rem] md:text-[1.375rem] font-semibold text-violet-600 ">
              ₹{fee}/min
            </h4>
          </div>
          <div className="w-[0.196px] bg-gray-700 mx-[0.66rem] md:mx-[1.39rem]"></div>
          <div className="flex flex-col items-center gap-[0.5rem] md:gap-4 p-[0.17rem]">
            <h3 className="text-[0.75rem] md:text-sm font-normal">
              Your Wallet Balance
            </h3>
        ...
        <h4 className="text-center text-[0.75rem] md:text-base font-medium text-gray-700 mt-[0.66rem] md:mt-[1.39rem]">
          Maximum call duration:
          <span className="text-violet-400 text-[0.75rem]  md:text-base font-medium">
            {" "}
            {minCallDuration} mins
          </span>
        </h4>
      </div>
      <div className="flex md:w-[20rem] md:mx-auto">
        <div>
          <h6 className="text-[0.75rem] md:text-base font-medium leading-none ">
            Note:{" "}
          </h6>
        </div>
        <div className="w-[11rem] md:w-full ml-[0.27rem] ">
          <h5 className="text-left text-[0.75rem] md:text-sm font-normal">
            Based on the amount in your wallet you will be disconnected after{" "}
            <span className="text-red-500 text-[0.75rem] md:text-sm  font-normal">
              {minCallDuration} mins
            </span>
          </h5>
        </div>
