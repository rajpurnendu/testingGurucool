...
import PaginatedItems from "../userprofile/consultationhistory/components/Paginateditems";
      ...
      <Suspense fallback={<h1>Loading...</h1>}>
        ...
        <div>
          <Modal
            ...
            onClose={closeModal}
          >
            <div className="w-full flex flex-col items-center gap-4 md:gap-7 ">
              {insufficientBalance ? (
                    ...
                    <button
                      ...
                      onClick={() => {
                        if (
                          ...
                          (datas?.callAvailability === "offline" ||
                            datas?.callAvailability === "busy") &&
                          loginToken
                        ) {
                          setLogin(false);
