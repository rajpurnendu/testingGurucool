...
import SuccessIcon from "../../../../public/images/wallet/Group 52345.svg";
import Link from "next/link";

const Paymentsuccess = ({ data }: { data: any }) => {
  return (
    <div className="w-[90%] mx-auto my-10 p-8 rounded-lg text-center shadow-[0_0_20px_rgba(0,0,0,0.2)] mt-[100px]">
      <div className="flex mb-5 justify-center">
        <Image src={SuccessIcon} height={80} width={150} alt="Succes Icon" />
      </div>
      <h2 className="font-bold text-[#159d43] leading-tight text-[1.25rem] mb-5">
