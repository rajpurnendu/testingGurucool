  ...
  return (
    <>
      <div className="flex flex-col items-center gap-[0.5rem]">
        ...
        <div className="w-[3.2rem] h-[3.2rem] md:w-[7.62rem] md:h-[7.62rem] rounded-full">
          <Image
        ...
        <div className="flex justify-center items-center gap-[0.1rem] md:gap-[0.26rem]">
          <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem] md:w-[1.73rem] md:h-[1.73rem]" />
          <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem] md:w-[1.73rem] md:h-[1.73rem]" />
          <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem] md:w-[1.73rem] md:h-[1.73rem]" />
          <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem] md:w-[1.73rem] md:h-[1.73rem]" />
          <IoIosStar className="text-yellow-400 w-[0.70rem] h-[0.70rem] md:w-[1.73rem] md:h-[1.73rem]" />
        ...
        <div className="flex justify-center items-center">
          ...
          <h4 className="text-[0.75rem] md:text-[1.125rem] font-normal text-slate-700 ml-[0.79rem]">
      ...
      <div className="w-[11.875rem] md:w-full py-[0.66rem]">
        ...
        <div className="md:p-2 md:mt-[0.16rem] flex justify-evenly flex-wrap">
          {consultationPoints.map((curr, index) => {
            return (
              <div
                key={curr.id}
              ...
              >
                ...
                >
                  <path
                    d="M23.1752 9.37651C22.8621 9.20229 22.5178 9.0915 22.1618 9.05047C21.8059 9.00944 21.4453 9.03897 21.1008 9.13739C20.7563 9.23581 20.4346 9.40117 20.154 9.62403C19.8734 9.84688 19.6395 10.1229 19.4657 10.4362L14.402 19.549L11.5039 16.6509C11.2523 16.3904 10.9514 16.1826 10.6186 16.0397C10.2858 15.8967 9.92789 15.8215 9.56573 15.8184C9.20356 15.8152 8.8444 15.8842 8.50919 16.0214C8.17398 16.1585 7.86944 16.361 7.61334 16.6171C7.35724 16.8732 7.15471 17.1778 7.01757 17.513C6.88042 17.8482 6.81141 18.2074 6.81456 18.5695C6.8177 18.9317 6.89295 19.2896 7.0359 19.6224C7.17885 19.9552 7.38664 20.2561 7.64715 20.5077L13.1023 25.9629C13.6178 26.4798 14.3133 26.7634 15.0307 26.7634L15.4085 26.7361C15.8265 26.6777 16.2253 26.5229 16.5734 26.2842C16.9215 26.0454 17.2095 25.7291 17.4146 25.3601L24.2335 13.086C24.4076 12.773 24.5183 12.4287 24.5594 12.0728C24.6004 11.717 24.5709 11.3565 24.4727 11.0121C24.3744 10.6676 24.2092 10.3459 23.9866 10.0652C23.764 9.78461 23.4883 9.55058 23.1752 9.37651Z"
                    fill="#222222"
                  />
                </svg>
...
export default ConsultationStartedModal;
