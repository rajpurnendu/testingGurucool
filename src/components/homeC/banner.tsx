...
import bannerImg from "../../../public/assets/background.svg";
import Link from "next/link";
import { sendGAEvent, sendGTMEvent } from "@next/third-parties/google";

const Banner = ({ loginToken }: { loginToken: any }) => {
  return (
    <div
      className={`w-full xl:h-[511px]   xl:flex justify-center gap-[5.25rem] items-center`}
    >
      <div className="relative md:absolute  md:top-[8%] md:z-[2] md:gap-[50px] md:w-full md:mx-auto xl:py-[8px] xl:static z-[10] xl:w-[72rem] gap-4 xl:m-auto flex justify-center items-center">
        <div className="flex flex-col  xl:gap-[3.19rem] gap-[15px]">
          <div className="flex flex-col gap-0 w-[117px] md:w-full xl:w-auto xl:gap-6">
            <h1 className="m-0 text-[#d9d9d9] text-base xl:text-[2.5rem] font-[500]">
              Unlock Astrology
            </h1>
          ...
          <p className="xl:text-[#d9d9d9] md:w-[400px] tracking-tighter  md:text-[#d9d9d9] text-[#d9d9d9] w-[290px] xl:w-[600px] text-xs md:text-xs xl:text-[1.125rem] leading-[15px] xl:leading-normal font-normal xl:font-[500] text-justify">
