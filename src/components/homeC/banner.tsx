...
const Banner = () => {
  return (
    ...
    >
      <Image
        priority
        className="relative xl:w-screen xl:h-[511px] hidden md:h-[400px] md:flex xl:flex w-full h-screen"
        src={bannerImg}
        alt="astrobanner"
        style={{ width: "100%", height: "auto" }}
      />

      <div className="relative md:absolute  md:top-[8%] md:z-[2] md:gap-[50px] md:w-full md:mx-auto xl:py-[8px] xl:absolute z-[10] xl:z-0 xl:w-[72rem] gap-4 xl:m-auto flex justify-center items-center">
        <div className="flex flex-col  xl:gap-[3.19rem] gap-[15px]">
          ...
          <p className="xl:text-white md:w-[400px] tracking-tighter  md:text-white  text-neutral-700 w-[290px] xl:w-[600px] text-xs md:text-xs xl:text-[1.125rem] leading-[15px] xl:leading-normal font-normal xl:font-[500] text-justify">
