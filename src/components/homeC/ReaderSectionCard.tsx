...
const ReaderSectionCard = ({
  ...
  return (
    <div
      className="mx-auto rounded-xl  min-w-[201px]  shadow hover:shadow-xl border transition duration-300 ease-in-out border-violet-500 border-opacity-40 bg-white p-2 flex flex-col items-center gap-[2.5px] xl:gap-[12px]"
      onClick={() => {
        if (loginToken) {
...
export default ReaderSectionCard;
